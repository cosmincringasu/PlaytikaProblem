...
{
    public class CsOperation : IOperation
    {

        public CsOperation(string originalStartFolder, string resultFile)
        {
        ...
        public async Task ProcessFolder(string path)
        {
            ...
            {
                if(Path.GetExtension(fileName).Equals(SharedConstants.FileExtension.CSFileExtension, StringComparison.InvariantCultureIgnoreCase))
